...
const SOURCE_DOMAIN = "https://dark-scan.com/"

export class DarkScan extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Dark Scan' }
    get description(): string { return 'More Updated Manga' }
